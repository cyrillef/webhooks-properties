    ...
    namespace Viewing {
        ...
        namespace Private {
            ...
            class MaterialManager {
              ...
              addHDRMaterial(name: string, mat: THREE.Material): void;
              addInstancingSupport(material: THREE.Material): THREE.Material;
              addLineMaterial(name: string, mat: THREE.Material, modelId: number): void;
              addMaterial(name: string, mat: THREE.Material, skipSimplePhongHeuristics: boolean): void;
              addMaterialNonHDR(name: string, mat: THREE.Material): void;
              addNonHDRMaterial(name: string, mat: THREE.Material): void;
        ...
        function AutodeskNamespace(ns: string): any;
    }
